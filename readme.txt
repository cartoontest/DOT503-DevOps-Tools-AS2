...
3. Add the build script and the Readme.txt file to your master branch. Commit the changes
...
2. Explain the concept of Infrastructure as Code (IaC) and its benefits in the context of
DevOps.